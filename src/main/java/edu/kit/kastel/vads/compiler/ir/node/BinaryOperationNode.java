...
public sealed abstract class BinaryOperationNode extends Node permits AddNode, AndNode, AndBWNode, 
    DivNode, EqualsNode, EqualsNotNode, GreaterNode, GreaterEqualNode, ModNode, MulNode, OrNode, 
